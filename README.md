<h1>Справочник командной оболочке Shell</h1>
...
<h2 id="раздел-2">Область применения командной строки</h2>
...
<h2 id="раздел-3">Особенности и преимущества командной строки</h2>
...
<h2 id="раздел-4">Как запустить командную строку</h2>

<h3 id="подраздел-4.1">Microsoft Windows</h3>
...
<h2 id="раздел-5">Виды командных строк</h2>
